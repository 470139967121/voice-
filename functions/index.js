...
// Migrated to Worker API — see worker-api/src/ (RoomDurableObject handles disconnect/owner-away/close)
/* exports.onPresenceRemoved — DISABLED */

// Migrated to Worker API — see worker-api/src/routes/reports.js (suspend endpoint + auth middleware)
/* exports.onUserSuspended — DISABLED */

// Migrated to Worker API — see worker-api/src/routes/conversations.js (FCM via worker-api/src/utils/fcm.js)
const { onDocumentCreated } = require("firebase-functions/v2/firestore");
const { getMessaging } = require("firebase-admin/messaging");
/* exports.sendPmNotification — DISABLED */
...
// Migrated to Worker API — see worker-api/src/routes/reports.js (FCM via worker-api/src/utils/fcm.js)
/* exports.onNewReport — DISABLED */
...
// Migrated to Worker API — see worker-api/src/routes/conversations.js (mod-log route + FCM)
/* exports.onModAction — DISABLED */
