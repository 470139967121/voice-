...
- **Feature files**: `app/src/androidTest/assets/features/*.feature` (21 files, 81 scenarios)
- **Step definitions**: `app/src/androidTest/java/com/shyden/shytalk/steps/` (CommonSteps, AuthSteps, SystemScreenSteps, ModerationSteps)
