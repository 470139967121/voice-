...
| 41  | **Admin panel restructure** — break 12,000+ line index.html into modular ES modules. PR A (core modules), PR B (tab extraction) merged. PR C (wiring + cleanup) pending                          | Large  | IN PROGRESS (PR A #289, PR B #301 merged; PR C pending)       |
