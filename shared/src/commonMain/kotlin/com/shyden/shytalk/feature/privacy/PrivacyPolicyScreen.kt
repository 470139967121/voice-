        ...
        Column(
            ...
            Column(
                ...
                BulletItem(buildAnnotatedString {
                    ...
                    append(" \u2013 transmitted in real time during voice chat sessions through the LiveKit SDK. Audio is streamed peer-to-peer and is ")
                ...
                BulletItem(buildAnnotatedString {
                    withStyle(SpanStyle(fontWeight = FontWeight.Bold)) { append("LiveKit") }
                ...
                Text(
                    text = "We use industry-standard security measures provided by Firebase and LiveKit, including encrypted data transmission (TLS). However, no method of electronic transmission or storage is 100% secure.",
                    style = MaterialTheme.typography.bodyMedium
                )
