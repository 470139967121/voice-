...
interface SeatRequestRepository {
    ...
    fun getRequestsByUser(roomId: String, userId: String): Flow<List<SeatRequest>>
    ...
    suspend fun cancelApprovedRequest(roomId: String, requestId: String, userId: String): Resource<Unit>
}
