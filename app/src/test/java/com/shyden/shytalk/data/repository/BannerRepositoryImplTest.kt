...
class BannerRepositoryImplTest {
    ...
    @Test
    fun `getActiveBanners excludes banner with future startDate`() = runTest {
    ...
    @Test
    fun `getActiveBanners excludes banner with past endDate`() = runTest {
    ...
    @Test
    fun `getActiveBanners includes banner with zero startDate`() = runTest {
    ...
    @Test
    fun `getActiveBanners includes banner with MAX_VALUE endDate`() = runTest {
    ...
    @Test
    fun `getActiveBanners sorts results by sortOrder`() = runTest {
    ...
    @Test
    fun `getActiveBanners returns empty list when no banners match`() = runTest {
    ...
    @Test
    fun `getActiveBanners returns Error on Firestore exception`() = runTest {
